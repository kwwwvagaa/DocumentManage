...
namespace DM.Tools
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "dm_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("dm_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("dm_licence", Licence.GetLicence());
        }
