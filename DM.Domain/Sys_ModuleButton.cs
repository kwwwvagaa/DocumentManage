...
{
    /// <summary>	
    /// 数据表实体类：模块按钮 (Sys_ModuleButton)
    /// </summary>
    [Serializable()]
    public partial class Sys_ModuleButton:BaseModel
    {
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_Location", _F_Location);
                return _F_Location;
            }
            set
            {
                if(!BeforeSetProperty("F_Location", _F_Location))
                    return;
                _F_Location=value;
                AfterSetProperty("F_Location", _F_Location);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_JsEvent", _F_JsEvent);
                return _F_JsEvent;
            }
            set
            {
                if(!BeforeSetProperty("F_JsEvent", _F_JsEvent))
                    return;
                _F_JsEvent=value;
                AfterSetProperty("F_JsEvent", _F_JsEvent);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_UrlAddress", _F_UrlAddress);
                return _F_UrlAddress;
            }
            set
            {
                if(!BeforeSetProperty("F_UrlAddress", _F_UrlAddress))
                    return;
                _F_UrlAddress=value;
                AfterSetProperty("F_UrlAddress", _F_UrlAddress);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_Split", _F_Split);
                return _F_Split;
            }
            set
            {
                if(!BeforeSetProperty("F_Split", _F_Split))
                    return;
                _F_Split=value;
                AfterSetProperty("F_Split", _F_Split);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_IsPublic", _F_IsPublic);
                return _F_IsPublic;
            }
            set
            {
                if(!BeforeSetProperty("F_IsPublic", _F_IsPublic))
                    return;
                _F_IsPublic=value;
                AfterSetProperty("F_IsPublic", _F_IsPublic);
             }
		}
