...
{
    /// <summary>	
    /// 数据表实体类：系统模块 (Sys_Module)
    /// </summary>
    [Serializable()]
    public partial class Sys_Module:BaseModel
    {
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_Target", _F_Target);
                return _F_Target;
            }
            set
            {
                if(!BeforeSetProperty("F_Target", _F_Target))
                    return;
                _F_Target=value;
                AfterSetProperty("F_Target", _F_Target);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_IsMenu", _F_IsMenu);
                return _F_IsMenu;
            }
            set
            {
                if(!BeforeSetProperty("F_IsMenu", _F_IsMenu))
                    return;
                _F_IsMenu=value;
                AfterSetProperty("F_IsMenu", _F_IsMenu);
             }
		}
	   ...
	   { 
            get
            {
                BeforeGetProperty("F_IsExpand", _F_IsExpand);
                return _F_IsExpand;
            }
            set
            {
                if(!BeforeSetProperty("F_IsExpand", _F_IsExpand))
                    return;
                _F_IsExpand=value;
                AfterSetProperty("F_IsExpand", _F_IsExpand);
             }
		}
