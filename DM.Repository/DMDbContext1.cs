...
namespace DM.Repository
{
    public partial class DMDbContext : DbContext
    {
        ...
        public DbSet<Sys_PageIndexSearch> Sys_PageIndexSearchs { get; set; }
        ...
        public DbSet<Sys_PageIndexTool> Sys_PageIndexTools { get; set; }
        ...
        public DbSet<Sys_PageIndex> Sys_PageIndexs { get; set; }
        public DbSet<Sys_PageIndexTableColumns> Sys_PageIndexTableColumnss { get; set; }
